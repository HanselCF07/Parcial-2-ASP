<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditarProductos.aspx.cs" Inherits="Parcial_2.EditarProductos" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="col-lg-6">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="tb_1c" runat="server" ErrorMessage="Debe ingresar Precio" Text="*" ForeColor="Red"></asp:RequiredFieldValidator>                     
                <asp:TextBox ID="tb_1c" runat="server" TextMode="Number" class="form-control"></asp:TextBox>                                         
                <br/>                   
                <asp:Label ID="Label4" runat="server" Text="Existencias"></asp:Label> 
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="tb_1d" runat="server" ErrorMessage="Debe ingresar Existencias" Text="*" ForeColor="Red"></asp:RequiredFieldValidator>                     
                <asp:TextBox ID="tb_1d" runat="server" TextMode="Number" class="form-control"></asp:TextBox>                                         
                <br/>
                <br/>  
